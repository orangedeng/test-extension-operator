...
func (v *version) Foo() FooController {
	return generic.NewNonNamespacedController[*v1.Foo, *v1.FooList](schema.GroupVersionKind{Group: "test.pandaria.io", Version: "v1", Kind: "Foo"}, "foos", v.controllerFactory)
}
